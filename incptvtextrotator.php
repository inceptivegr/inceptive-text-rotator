<?php
/*------------------------------------------------------------------------
# incptvtextrotator.php - Inceptive Text Rotator Content Plugin
# ------------------------------------------------------------------------
...
class plgContentIncptvtextrotator extends JPlugin {
    
    var $plg_copyrights_start		= "\n\n<!-- Inceptive \"Text Rotator\" Content Plugin (v1.0) starts here -->\n";
    var $plg_copyrights_end		= "\n<!-- Inceptive \"Text Rotator\" Content Plugin (v1.0) ends here -->\n\n";

    function plgContentIncptvtextrotator( &$subject )
    {
